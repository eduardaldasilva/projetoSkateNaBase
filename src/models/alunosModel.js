...
const atualizar = (
  ...
  return db.oneOrNone(
    "update alunos set nome = $1, nome_responsavel = $2, status_aluno = $3, data_nascimento = $4, telefone = $5, cep = $6, logradouro = $7, numero = $8, bairro = $9, id_turma = $10 where id_aluno = $11 returning *",
    [
      nome,
      nome_responsavel,
      status_aluno,
